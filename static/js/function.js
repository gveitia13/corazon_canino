$(function () {
  ...
  if (window.location.pathname.includes('ficha'))
    changeSidebar('.ficha-sidebar')
  if (window.location.pathname.includes('contacto'))
    changeSidebar('.contacto-sidebar')
  if (window.location.pathname.includes('visitas'))
    changeSidebar('.visita-sidebar')
  if (window.location.pathname.includes('evento'))
    changeSidebar('.evento-sidebar')
  if (window.location.pathname.includes('informacion'))
    changeSidebar('.informacion-sidebar')
  if (window.location.pathname.includes('asociado'))
    changeSidebar('.asociado-sidebar')
  if (window.location.pathname.includes('enfermedad'))
    changeSidebar('.enfermedades-sidebar')
  if (window.location.pathname.includes('vacuna'))
